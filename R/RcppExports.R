...
jfm_s0s1_score_fused_cpp <- function(tl_type, tl_idx, tl_size, Z_pseudo, coef, event_pseudo_idx, ne, n) {
    .Call(`_swjm_jfm_s0s1_score_fused_cpp`, tl_type, tl_idx, tl_size, Z_pseudo, coef, event_pseudo_idx, ne, n)
}
