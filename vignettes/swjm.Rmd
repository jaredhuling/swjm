...
author: "Lingfeng Huo, Jared Huling"
date: "`r Sys.Date()`"
output:
...
Rondeau, V., Mathoulin-Pelissier, S., Jacqmin-Gadda, H., Brouste, V., and
Soubeyran, P. (2007). Joint frailty models for recurring events and death
using maximum penalized likelihood estimation: Application in transplantation.
