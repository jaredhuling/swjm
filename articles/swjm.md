...
#>  [1]  1.0089 -0.9935  0.1288 -0.0393  0.0007  0.0000  0.0179  0.0036  0.8539
#> [10] -0.8917
```
...
#> Stagewise path (jfm/coop)
#> 
#>   p = 10  |  5000 iterations  |  lambda: [0.1308, 1.442]
#>   Decreasing path: 452 steps
#> 
#>   Path-end coefficients (nonzero variables):
#> 
#>   Variable    alpha       beta        Type
#>   ----------  ----------  ----------  ----------------
#>   x10         -0.8917     -0.9090     shared (+)
#>   x3          +0.1288     +1.1723     shared (+)
#>   x9          +0.8539     +0.9296     shared (+)
#>   x1          +1.0089     +0.2740     shared (+)
#>   x2          -0.9935     -0.0364     shared (+)
#>   x4          -0.0393     -1.1693     shared (+)
#>   x8          +0.0036     +0.0799     shared (+)
#>   x5          +0.0007     +0.0100     shared (+)
#>   x7          +0.0179     +0.0089     shared (+)
...
Full path: 5001 steps; decreasing path: 452 steps
...
#> 
#>   Covariates (p):              10
#>   Lambda grid size:            452
#>   Best position (combined):    452  (lambda = 0.1308)
...
#> [1]  1.0089 -0.9935  0.1288 -0.0393  0.0007  0.0180  0.0036  0.8539 -0.8917
```
...
#>  [1]  0.2740 -0.0364  1.1723 -1.1693  0.0100 -0.0100  0.0089  0.0799  0.9296
#> [10] -0.9090
```
...
#> 
#>   p = 10  |  Lambda grid: 452 steps  |  CV optimal: step 452 (lambda = 0.1308)
#> 
...
#> 1  0.5          0.5761528   0.01758867
#> 2  1.0          1.1230954   0.03232249
#> 3  2.0          2.0849933   0.07514479
#> 4  4.0          4.0043381   0.14633771
#> 5  6.0          5.5528492   0.19832464
```
...
#>  2.3076  0.4096  0.0963 -0.0860  0.0015 -0.0001  0.0026  1.0870 -0.5277
```
...
#>  0.6267  0.0150  0.8771 -2.5608  0.0228 -0.0047  0.0000  0.0564  1.1833 -0.5379
```
